...
const CPF_UNIQUENESS_GATE_BLOCKERS = Object.freeze({
  ...
  EXECUTIVE_POLICY_NOT_CONFIRMED: "EXECUTIVE_POLICY_NOT_CONFIRMED",
...
const BUSINESS_DECISION_BLOCKERS = Object.freeze({
  adultStudentCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  alternativeDocumentPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  ...
  cpfHistoryPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  cpfValidationPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  duplicateCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  entityNatureDecision: CPF_UNIQUENESS_GATE_BLOCKERS.LEGAL_ENTITY_MODEL_NOT_CONFIRMED,
  ...
  invalidLegacyCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  invalidNewCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.NULL_NORMALIZED_POLICY_NOT_CONFIRMED,
  ...
  minorStudentCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  personScopeDecision: CPF_UNIQUENESS_GATE_BLOCKERS.IDENTITY_SCOPE_NOT_CONFIRMED,
  physicalDeletionPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  privacyAuthorizationPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
  responsibleCpfPolicy: CPF_UNIQUENESS_GATE_BLOCKERS.EXECUTIVE_POLICY_NOT_CONFIRMED,
});
