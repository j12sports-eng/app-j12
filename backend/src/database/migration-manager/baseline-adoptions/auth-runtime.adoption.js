...
const legacyColumns = Object.freeze({
  id: Object.freeze({ position: 1, columnType: "int(11)", nullable: false, default: null, autoIncrement: true, extra: "auto_increment", charset: null, collation: null }),
  nome: Object.freeze({ position: 2, columnType: "varchar(150)", nullable: false, default: null, autoIncrement: false, extra: "", charset: "utf8", collation: "utf8_unicode_ci" }),
  email: Object.freeze({ position: 3, columnType: "varchar(150)", nullable: false, default: null, autoIncrement: false, extra: "", charset: "utf8", collation: "utf8_unicode_ci" }),
  senha_hash: Object.freeze({ position: 4, columnType: "varchar(255)", nullable: false, default: null, autoIncrement: false, extra: "", charset: "utf8", collation: "utf8_unicode_ci" }),
  perfil: Object.freeze({ position: 5, columnType: "enum('admin','professor','responsavel','aluno')", nullable: false, default: "aluno", autoIncrement: false, extra: "", charset: "utf8", collation: "utf8_unicode_ci" }),
  aluno_id: Object.freeze({ position: 6, columnType: "int(11)", nullable: true, default: null, autoIncrement: false, extra: "", charset: null, collation: null }),
  professor_id: Object.freeze({ position: 7, columnType: "int(11)", nullable: true, default: null, autoIncrement: false, extra: "", charset: null, collation: null }),
  responsavel_id: Object.freeze({ position: 8, columnType: "int(11)", nullable: true, default: null, autoIncrement: false, extra: "", charset: null, collation: null }),
  status: Object.freeze({ position: 9, columnType: "enum('ativo','inativo')", nullable: true, default: "ativo", autoIncrement: false, extra: "", charset: "utf8", collation: "utf8_unicode_ci" }),
  created_at: Object.freeze({ position: 10, columnType: "timestamp", nullable: false, default: "CURRENT_TIMESTAMP", autoIncrement: false, extra: "", charset: null, collation: null }),
  updated_at: Object.freeze({ position: 11, columnType: "timestamp", nullable: false, default: "CURRENT_TIMESTAMP", autoIncrement: false, extra: "on update CURRENT_TIMESTAMP", charset: null, collation: null }),
});
...
const legacyIndexes = Object.freeze({
  ...
  idx_j12_usuarios_professor: Object.freeze({ unique: false, columns: Object.freeze(["professor_id"]) }),
  idx_j12_usuarios_responsavel: Object.freeze({ unique: false, columns: Object.freeze(["responsavel_id"]) }),
